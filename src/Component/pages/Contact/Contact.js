  ...
  <div className="container"> 
    <div className="row">
      <div className="col-12 col-md-10 col-lg-8">
        ...
        <h2 className="display-5 mb-4 mb-md-5 mb-xl-8"> Please get in hlep from one of the following ways.</h2>
      </div>
    </div>
  </div>
          ...
          <div className="col-12 col-xl-11">
            <div className="mb-4 mb-md-5">
              ...
              <div>
                ...
                <address className="m-0 text-secondary">14/1a Karpaga Nagar .Thirumanagalam,Madurai</address>
              </div>
            </div>
              ...
              <div className="col-12 col-sm-6">
                <div className="mb-4 mb-sm-0">
                  ...
                  <div>
                    ...
                    <p className="mb-0">
                      <a className="link-secondary text-decoration-none" href="tel:+15057922430">(91)9787583303</a>
                    </p>
                  </div>
                </div>
              </div>
              <div className="col-12 col-sm-6">
                <div className="mb-4 mb-sm-0">
                  ...
                  <div>
                    ...
                    <hr className="w-75 mb-3 border-dark-subtle"/>
                    <p className="mb-0">
                      <a className="link-secondary text-decoration-none" href="mailto:demo@yourdomain.com">aakash2867@gmail.com</a>
                    </p>
                  </div>
                </div>
              </div>
